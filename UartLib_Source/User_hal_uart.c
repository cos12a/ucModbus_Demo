...
static HAL_StatusTypeDef UART1_Transmit_IT(UART_HandleTypeDef *huart);
static HAL_StatusTypeDef UART1_EndTransmit_IT(UART_HandleTypeDef *huart);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_UART1_Transmit_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  /* Check that a Tx process is not already ongoing */
  if (huart->gState == HAL_UART_STATE_READY)
  {
...
__weak void UART1_TxDMACplt_Callback(DMA_HandleTypeDef *hdma)
{
